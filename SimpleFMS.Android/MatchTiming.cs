...
namespace SimpleFMS.Android
{
    public class MatchTiming : IDisposable
    {
        ...
        private TableLayout m_matchStoppedLayout;
        private TableLayout m_matchRunningLayout;
        ...
        public MatchTiming(RelativeLayout parentLayout, TableLayout matchStopped, TableLayout matchRunning,
            BaseFMSLayout parent, RetaintedDeviceState retainedState)
        {
